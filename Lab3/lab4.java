...
public class lab4 {
    ...
    ArrayList<String> pipeline_state) {
        ...
        if (command_array[0].equals("h")) {
            ...
            String if_id = pipeline_state.get(pipeline_state.size()-1);
            String id_exe = pipeline_state.get(pipeline_state.size()-2);
            String exe_mem = pipeline_state.get(pipeline_state.size()-3);
            String mem_wb = pipeline_state.get(pipeline_state.size()-4);
