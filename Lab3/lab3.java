...
public class lab3 {
    public static void main(String args[])
    {
        ...
        //     System.out.println(register_names[i]);
        // }
        ...
        if (args.length > 1) { //aka, there IS a script command
            ...
            for (int i = 0; i < script_commands.size(); i++) {
                ...
                run_commands(command, register_array, register_names, data_memory, pc, nested_arrays, registers, label_lines, register_nums);
            }
        }
        else { //no script file
            String command = "";
    ...
    HashMap <String, Integer> register_nums) {
        ...
        if (operation.equals("and")) {
            ...
            // System.out.println(register_array[dest_register_num]);
            pc[0]++;
            ...
            //pc[0]++;
            // System.out.println("0 = " + nested_arrays.get(pc[0]).get(0));
            // System.out.println("1 = " + nested_arrays.get(pc[0]).get(1));
    ...
    HashMap <String, String> registers,
    HashMap <String, String> label_lines,
    HashMap <String, Integer> register_nums, int num) {
        for (int i = 0; i < num; i++) {
            s_command(register_array, register_names, data_memory, pc, nested_arrays, registers, label_lines, register_nums);
        }
    }
    ...
    HashMap <String, Integer> register_nums) {
        ...
        // System.out.println(command.length() == 2);
        ...
        if (command_array[0].equals("h")) {
            ...
            register_nums, Integer.parseInt(command_array[1]));
        }
            ...
            // for (int i = 0; i<m_command_array.length; i++) {
            //     System.out.println(m_command_array[i]);
            // }
    ...
    public static void make_script_array(String filename, ArrayList<String> script_commands){
        try {
            ...
            // for (int i = 0; i < script_commands.size(); i++) {
            //     System.out.println(script_commands.get(i));
            // }
        }
    ...
    public static int branch_calculate(int curr_line, int label_line) {
        ...
        // System.out.println("curr lin plus 1 = " + (curr_line + 1));
        // System.out.println(label_line - (curr_line + 1));
